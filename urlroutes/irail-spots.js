...
exports.getStationsInRadius = function(req, res) {
  ...
  getStationsLocal(latitude, longitude, function(result) {
    res.send(result);
  });
}
...
function getStationsRemote(latitude, longitude, callback) {
  ...
  var uri = 'https://data.irail.be/NMBS/Stations.json';
...
function getStationsLocal(latitude, longitude, callback) {
  try {
    //var fileJSON = require('../irail-stations.json');
    //var stations = fileJSON.Stations;
